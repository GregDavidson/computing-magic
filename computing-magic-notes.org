...
https://github.com/GregDavidson/computing-magic/blob/main/computing-magic-notes.org
...
3. Languages which have /lambda functions/ can do a much more efficient and
   ...
   which can be sent over network channels to be excuted remotely, stored in
