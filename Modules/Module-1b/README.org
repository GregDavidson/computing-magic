...
- Important :: Only use the turtle commands
- =(move distance)=
- =(draw distance)=
- =(turn angle)=
...
More examples are at [[https://github.com/racket/htdp/blob/master/htdp-lib/graphics/turtle-examples.rkt][turtle-examples.rkt]].
...
** Making Turtle Graphics /Functional?/
