#lang racket
;; * Flight Lander Game (2htdp, Lang Racket, Mutable Sprites)

;; ** Overview

;; Imperative Programming used sparingly.
;; Only Sprites are Mutable Objects.
...
;; Position and Size values in the image drawing toolkit
;; are in Pixels.

;; The 2http place-image function places (draws) an image relative to the center
;; of its bounding box. We prefer to place an image relative to the lower-left
;; corner of its bounding box.

;; We'll often need to split pixel counts in half,
