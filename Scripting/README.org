...
- Note :: [[https://en.wikipedia.org/wiki/Linux_kernel][Linux]] is a /Kernel/ which manages the /Computer Hardware/ for a
  [[https://www.gnu.org/gnu/linux-and-gnu.en.html][Gnu/Linux System]]. [[https://www.gnu.org/philosophy/categories.html#TheGNUsystem][A Gnu System]] provides several /User Interfaces/, including a
