#+TITLE: League Of Extraordinary Learners
...
These are some fairly rough notes on the design of the LOEL Computing
Magic Curriculum.  Perhaps they'll be useful for anyone working on
improving that curriculum.
